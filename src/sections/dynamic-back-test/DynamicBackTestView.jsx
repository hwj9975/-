...
export default function DynamicTestView() {
  const strategyPresets = [
    { name: '듀얼 모멘텀', values: [{etf:"QQQ", value:23}, {etf:"EFA", value:50}, {etf:"HYG", value:27}] },
    { name: '가속 듀얼 모멘텀', values: [{etf:"IWD", value:12}, {etf:"EFA", value:50}, {etf:"IWD", value:5}, {etf:"TLT", value:37}] },
  ];
      ...
      >
        ...
        <CardContent>
          <Stack spacing={3}>
            ...
            <Stack direction="row" spacing={1} alignItems="center">
              ...
              >
                <MenuItem value={'absolute'}>절대</MenuItem>
                <MenuItem value={'relative'}>상대</MenuItem>
              </TextField>
            </Stack>
          </Stack>
        </CardContent>
        <CardActions>
          ...
          >
            ...
            <Button
              variant="outlined"
              onClick={onStrategySaveClick}
              sx={{
                width: '120px',
              }}
            >
              {name ? '전략 수정하기' : '전략 저장하기'}
            </Button>
            {name && (
              <Button
                variant="outlined"
